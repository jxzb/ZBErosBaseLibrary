...
+ (NSString*)getStatusText:(NSInteger)code
{
    switch (code) {
        ...
        case 400:
            return @"连接失败: Bad Request";
        case 401:
            return @"连接失败: Unauthorized";
        case 402:
            return @"连接失败: Payment Required";
        case 403:
            return @"连接失败: Forbidden";
        case 404:
            return @"连接失败: Not Found";
        case 405:
            return @"连接失败: Method Not Allowed";
        case 406:
            return @"连接失败: Not Acceptable";
        case 407:
            return @"连接失败: Proxy Authentication Required";
        case 408:
            return @"请求超时";
        case 409:
            return @"连接失败: Conflict";
        case 410:
            return @"连接失败: Gone";
        case 411:
            return @"连接失败: Length Required";
        case 412:
            return @"连接失败: Precondition Failed";
        case 413:
            return @"连接失败: Payload Too Large";
        case 414:
            return @"连接失败: URI Too Long";
        case 415:
            return @"连接失败: Unsupported Media Type";
        case 416:
            return @"连接失败: Range Not Satisfiable";
        case 417:
            return @"连接失败: Expectation Failed";
        case 418:
            return @"连接失败: I'm a teapot";
        case 421:
            return @"连接失败: Misdirected Request";
        case 422:
            return @"连接失败: Unprocessable Entity";
        case 423:
            return @"连接失败: Locked";
        case 424:
            return @"连接失败: Failed Dependency";
        case 426:
            return @"连接失败: Upgrade Required";
        case 428:
            return @"连接失败: Precondition Required";
        case 429:
            return @"连接失败: Too Many Requests";
        case 431:
            return @"连接失败: Request Header Fields Too Large";
        case 451:
            return @"连接失败: Unavailable For Legal Reasons";
        ...
        case 503:
            return @"服务器内部错误";
        case 504:
            return @"连接失败: Gateway Timeout";
        case 505:
            return @"连接失败: HTTP Version Not Supported";
        case 506:
            return @"连接失败: Variant Also Negotiates";
        case 507:
            return @"连接失败: Insufficient Storage";
        case 508:
            return @"连接失败: Loop Detected";
        case 510:
            return @"连接失败: Not Extended";
        case 511:
            return @"连接失败: Network Authentication Required";
        default:
            break;
    }
